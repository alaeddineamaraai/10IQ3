...
export function TopHeader({ profile }: { profile: AthleteProfile }) {
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between border-b border-border/20 bg-background/20 px-4 py-4 backdrop-blur-xl sm:px-6 lg:px-10">
